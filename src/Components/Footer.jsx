    ...
    return (
        <footer className='w-full flex justify-center items-center border-t border-zinc-950 dark:border-gray-100 mt-10 tracking-tight'>
            <div className='sm:w-10/12 sm:max-w-footer sm:grid sm:grid-cols-2 grid-cols-1 gap-20 h-full text-sm'>
                <section className='flex flex-col items-center justify-between gap-3 py-10 w-full'>
                ...
                <section className='flex flex-col items-center justify-between gap-10 px-5 py-10 sm:border-t-0 border-t border-zinc-950 dark:border-gray-100'>
                    ...
                    <div>
                        <p className='font-bold cursor-default text-center mb-2'>
                            Find Us
                        </p>
