...
export default function Footer() {
    return (
        <footer className='w-full flex justify-center items-center sm:h-60 h-fit border-t border-zinc-950 dark:border-gray-100 p-5 mt-10 py-10 tracking-tight'>
            <div className='sm:w-9/12 sm:max-w-footer sm:grid sm:grid-cols-2 grid-cols-1 gap-20 sm:h-36 text-sm'>
                <section className='flex flex-col items-center justify-between sm:gap-3 mb-7 w-full'>
                ...
                <section className='flex flex-col items-center sm:border-t-0 border-t py-7 px-5 sm:py-0 border-zinc-950 dark:border-gray-100 relative'>
                    ...
                    <section className='w-full flex justify-center'>
                        <div className='sm:absolute sm:bottom-0 sm:mb-7 w-10 sm:w-full leading-6 sm:leading-none text-3xl sm:text-4xl hover:text-brand text-center font-Tiny5 font-bold tracking-tighter cursor-default'>
                            one more roll
                        </div>
                    </section>
                </section>
