            ...
            <button
                ...
                className={
                    text === 'Login' || text === 'Logout' || text === 'Order'
                        ? `${
                              text === 'Order' ? 'h-10' : 'h-6'
                          } bg-zinc-800 dark:bg-gray-100 hover:bg-brand text-gray-50 dark:text-zinc-800 dark:hover:text-gray-50 font-Silkscreen px-2 tracking-tighter transition-all active:brightness-110`
                        : text
