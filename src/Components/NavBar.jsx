...
export default function NavBar() {
    ...
    return (
        <header className='px-5 border-b border-zinc-900 dark:border-gray-50 sticky top-0 pt-2 bg-gray-100 text-zinc-950 dark:bg-zinc-950 dark:text-gray-50 z-50'>
